...
24 Python modules across 5 subpackages, 553 tests, no mocks.
...
| `manuscript/` | Template variable computation and injection | All output JSONs | `dict[str, str]` of 127+ variables |
...
# 553 tests, no mocks, deterministic
```
