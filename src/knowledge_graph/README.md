...
Evidence synthesis engine for the Active Inference Meta-Analysis. Converts LLM-extracted
...
### `hypothesis.py`
Defines 8 standard hypotheses (FEP_UNIVERSALITY, AIF_OPTIMALITY, MARKOV_BLANKET_REALISM,
