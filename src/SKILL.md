...
You are interfacing with the `src/` directory of the Active Inference Meta-Analysis project. This directory contains 45+ public APIs spread across 5 submodules.
