...
2. **No mock policy**: All tests use real data, real files, real computations (686 passed, 1 skipped in the latest gate).
...
686 passed, 1 skipped, 90.06% coverage in the latest gate. Run: `uv run pytest tests/ -q --cov=src --cov-fail-under=90`
