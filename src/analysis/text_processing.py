...
construction for Active Inference literature meta-analysis.
"""
...
STOPWORDS: set[str] = {
    ...
    "could", "not", "no", "nor", "so", "too", "very", "just", "also",
    "than", "then", "that", "this", "these", "those", "it", "its",
    "he", "she", "they", "we", "you", "me", "him", "her", "us", "them",
    "my", "your", "his", "our", "their", "mine", "yours", "hers", "ours",
    "theirs", "who", "whom", "which", "what", "where", "when", "how",
    "all", "each", "every", "both", "few", "more", "most", "other",
    "some", "such", "any", "only", "own", "same", "about", "up", "out",
    "into", "over", "after", "before", "between", "under", "again",
    "further", "once", "here", "there", "why", "because", "during",
    "while", "through", "above", "below", "itself", "himself", "herself",
