...
- **Fixed DPI**: All figures use `VIZ_CONFIG["dpi"]` (default 300). Do not hardcode a different
...
4. Register the figure in `scripts/04_generate_figures.py` figure registry.
