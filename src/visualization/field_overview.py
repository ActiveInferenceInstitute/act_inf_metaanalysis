"""Field overview visualizations for Active Inference meta-analysis.

Provides summary bar charts and pie charts showing the distribution
of publications across Active Inference subfields.
"""
...
def plot_field_summary(
    ...
    colors = [
        VIZ_CONFIG["subfield_colors"].get(sf, VIZ_CONFIG["palette"][0])
        for sf in subfields
    ]
    ...
    ax.set_title(
        f"Active Inference Literature by Subfield (N={total_papers})",
