...
- `testing.md`: Explains the strict zero-mock execution environment and testing philosophy (latest verified gate: 654 passed, 1 skipped, 90.07% coverage; see `testing.md` for refresh commands).
