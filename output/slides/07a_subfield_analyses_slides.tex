...
\begin{block}{A1 --- Quantitative \& Formal Theory (\(n = 59\), 7.5\%)}
\protect\phantomsection\label{a1-quantitative-formal-theory-n-59-7.5}
...
(\(n = 66\), 8.4\%)}
\protect\phantomsection\label{a2-qualitative-philosophy-general-theory-n-66-8.4}
...
\begin{block}{B --- Algorithms, Scaling, and Software (\(n = 166\),
21.1\%)}
\protect\phantomsection\label{b-algorithms-scaling-and-software-n-166-21.1}
...
\begin{block}{C1 --- Neuroscience (\(n = 148\), 18.9\%)}
\protect\phantomsection\label{c1-neuroscience-n-148-18.9}
...
\begin{block}{C2 --- Robotics (\(n = 126\), 16.1\%)}
\protect\phantomsection\label{c2-robotics-n-126-16.1}
...
\begin{block}{C3 --- Language Processing (\(n = 58\), 7.4\%)}
\protect\phantomsection\label{c3-language-processing-n-58-7.4}
...
\begin{block}{C4 --- Computational Psychiatry (\(n = 31\), 3.9\%)}
\protect\phantomsection\label{c4-computational-psychiatry-n-31-3.9}
...
\begin{block}{C5 --- Biology \& Morphogenesis (\(n = 131\), 16.7\%)}
\protect\phantomsection\label{c5-biology-morphogenesis-n-131-16.7}
