...
\begin{frame}{Appendix: Accessibility, Cognitive Ergonomics, and
Participatory Research Infrastructure \label{sec:accessibility}}
\protect\phantomsection\label{appendix-accessibility-cognitive-ergonomics-and-participatory-research-infrastructure}
...
\begin{block}{Cognitive Ergonomics of Knowledge Graphs}
\protect\phantomsection\label{cognitive-ergonomics-of-knowledge-graphs}
...
\begin{block}{Action--Intention UX and Active Inference Design
Principles}
\protect\phantomsection\label{actionintention-ux-and-active-inference-design-principles}
...
\begin{block}{Risk-Aware and Bias-Transparent Design}
\protect\phantomsection\label{risk-aware-and-bias-transparent-design}
...
\begin{block}{FAIR Data and Decentralized Science}
\protect\phantomsection\label{fair-data-and-decentralized-science}
...
\begin{block}{Participatory Research and Universal Access}
\protect\phantomsection\label{participatory-research-and-universal-access}
