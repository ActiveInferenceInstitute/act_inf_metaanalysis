...
\begin{frame}[fragile]{Appendix A: Mathematical and Algorithmic Details
\label{sec:technical_appendix}}
\protect\phantomsection\label{appendix-a-mathematical-and-algorithmic-details}
...
\begin{block}{A.5 Nanopublication RDF Schema \label{sec:appendix_rdf}}
\protect\phantomsection\label{a.5-nanopublication-rdf-schema}
