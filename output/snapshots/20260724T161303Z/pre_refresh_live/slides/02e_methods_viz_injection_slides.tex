...
\begin{frame}[fragile,allowframebreaks]{Stages 4--5: Visualization,
Variable Injection, and Reproducibility \label{sec:methods_viz}}
\protect\phantomsection\label{stages-45-visualization-variable-injection-and-reproducibility}
