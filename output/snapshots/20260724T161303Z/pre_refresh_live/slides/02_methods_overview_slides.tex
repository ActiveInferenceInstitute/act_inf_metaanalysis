...
\begin{frame}[fragile,allowframebreaks]{Methodology: Pipeline Design and
Formal Definitions \label{sec:methods}}
...
\begin{frame}[fragile,allowframebreaks]{Pipeline Overview}
...
\begin{frame}[fragile,allowframebreaks]{Reproducible Build
Infrastructure}
\protect\phantomsection\label{reproducible-build-infrastructure}
