...
\begin{frame}[allowframebreaks]{Appendix: Tooling and Infrastructure
\label{sec:tooling}}
...
\begin{frame}[allowframebreaks]{LLM-Based Assertion Extraction}
...
\begin{frame}[fragile,allowframebreaks]{Software Ecosystem}
...
dominates (\$\sim\$75\% of implementations), with Julia emerging as the
...
\begin{frame}[allowframebreaks]{Knowledge Graph Infrastructure}
...
Appendix\textasciitilde{}\ref{sec:appendix_rdf}.
...
\begin{frame}[allowframebreaks]{Multi-Level Quality Assurance}
