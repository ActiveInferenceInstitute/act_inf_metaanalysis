...
**Injection sources:**
- `corpus.jsonl` → `817`, `2005`, `2026`
- `temporal_analysis.json` → `20.36`, `2025`, `123`, `2.8`
- `subfield_classification.json` → `64`, `7.8`, `170`, `20.8`, `161`, `19.7` … (per domain)
- `citation_network.json` → `817`, `2,176`, `0.33`, `7.4`
- `assertion_summary.json` → `1,671`, `82.4`, `17.6`
- `hypothesis_scores.json` → `+0.13`, `67`, `703`, `3` … (per hypothesis)
- `topics.json` → `8`, `500`
- Hardcoded → `16` (= 16)
