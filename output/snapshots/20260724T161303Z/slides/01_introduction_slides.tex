...
\begin{frame}[allowframebreaks]{The Free Energy Principle and Active
Inference Framework}
...
\begin{frame}[allowframebreaks]{Challenges Posed by Rapid Literature
Growth}
...
\begin{frame}[fragile,allowframebreaks]{Related Work and Prior
Meta-Analyses}
...
\begin{frame}[allowframebreaks]{Synergizing Knowledge Graphs and LLMs}
...
\begin{frame}[allowframebreaks]{This Study: Approach and Overview}
...
\begin{frame}[allowframebreaks]{Scope and Delimitations}
...
\begin{frame}[allowframebreaks]{Principal Contributions}
