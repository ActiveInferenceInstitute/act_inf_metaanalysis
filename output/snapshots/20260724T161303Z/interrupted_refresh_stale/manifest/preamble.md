...
% Cross-references and citations (natbib is auto-injected by Pandoc via --natbib;
% hyperref is loaded by citeproc/citepackage; set options only here to avoid clashes)
