...
class TestGetPapersForHypothesis:
    ...
    def test_returns_correct_papers(self, use_rdflib: bool) -> None:
        ...
        kg.add_paper(p2)
        kg.add_assertion(
            _make_assertion("ha1", "hp1", hypothesis_id="SCALABILITY")
        )
        kg.add_assertion(
            _make_assertion("ha2", "hp2", hypothesis_id="CLINICAL_UTILITY")
        )
    ...
    def test_empty_for_unused_hypothesis(self, use_rdflib: bool) -> None:
        ...
        kg = KnowledgeGraph(use_rdflib=use_rdflib)
        assert kg.get_papers_for_hypothesis("LANGUAGE_AIF") == []
...
class TestFullGraph:
    ...
    def test_full_build(self, use_rdflib: bool) -> None:
        ...
        assertions = [
            _make_assertion("fa1", "full0", "supports", "FEP_UNIVERSALITY"),
            _make_assertion("fa2", "full1", "contradicts", "SCALABILITY"),
            _make_assertion("fa3", "full2", "supports", "PREDICTIVE_CODING"),
        ]
        for a in assertions:
            kg.add_assertion(a)
        ...
        fep_papers = kg.get_papers_for_hypothesis("FEP_UNIVERSALITY")
