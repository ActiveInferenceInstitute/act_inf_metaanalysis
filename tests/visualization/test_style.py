...
class TestVizConfig:
    ...
    def test_config_has_required_keys(self) -> None:
        required = [
            "figure_size", "dpi", "font_size", "title_size",
            "palette", "subfield_colors", "grid_alpha", "edge_color",
        ]
        for key in required:
    ...
    def test_subfield_colors_covers_all_domains(self) -> None:
        expected_domains = [
            "A2_philosophy", "A1_formal", "B_tools", "C1_neuroscience",
            "C2_robotics", "C3_language", "C4_psychiatry", "C5_biology",
        ]
