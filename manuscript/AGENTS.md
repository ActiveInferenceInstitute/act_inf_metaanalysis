...
**Never edit files under `output/manuscript/` directly** — those are generated by the canonical Stage 5 hydrator.
...
| `02_methods_overview.md` | End-to-end pipeline definition and reproducibility framing |
...
| `02e_methods_viz_injection.md` | Visualization, validation, and variable hydration pipeline |
