...
The present corpus of $N = {{CORPUS_SIZE}}$ papers is retrieved via keyword queries against three APIs (Semantic Scholar, OpenAlex, arXiv). Three expansion axes would materially change the evidence landscape.
