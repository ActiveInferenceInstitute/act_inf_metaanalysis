...
#### B — Algorithms, Scaling, and Software (n = {{B_COUNT}}, {{B_PCT}} percent)
...
#### C1 — Neuroscience (n = {{C1_COUNT}}, {{C1_PCT}} percent)
...
#### C2 — Robotics (n = {{C2_COUNT}}, {{C2_PCT}} percent)
...
#### C3 — Language Processing (n = {{C3_COUNT}}, {{C3_PCT}} percent)
...
#### C4 — Computational Psychiatry (n = {{C4_COUNT}}, {{C4_PCT}} percent)
